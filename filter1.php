  ...
  filter: saturate(0.02) contrast(0.85) brightness(1.2) sepia(0.02);
	  ...
	  <script type="text/javascript">
        function filterWillow(){
            document.getElementById('img').className ='ig-willow';
        }
...
<img id="img" src="./img/Cake.jpg" >

<p>
For <span id="f1">willow</span> filter<input name="Willow" value="Willow" type="button" onclick="filterWillow()" /> </p>
